...
def info():
  ...
  print "[*] Examples:"
  print "[>] ./Plomo-Cracker.py -h <hash> -t md5 -w DICT.txt"
  print "[>] ./Plomo-Cracker.py -h <hash> -t sha384 -n -v"
...
def main(argv):
  ...
  try:
      ...
      print '[*]./Plomo-Cracker.py -t <type> -h <hash> -w <wordlist>'
      print '[*]Type ./Plomo-Cracker.py -i for information'
      sys.exit(1)
  for opt, arg in opts:
      if opt == '-i':
          info()
